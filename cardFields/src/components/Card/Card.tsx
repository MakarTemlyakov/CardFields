        ...
        <main className='rounded-[4px] bg-white py-10 px-20  w-full h-full flex flex-col '>
            ...
            <div className='flex flex-col gap-10 w-1/2 h-full' >
                <div className='grid grid-cols-2'>
                    <Typography variant='h5' mb='5px'><span className='truncate'>Обязательынй филд:</span></Typography>
                ...
                <div className='grid grid-cols-2'>
                    <Typography variant='h5' mb='5px' className='flex flex-1'>айпи адрес:</Typography>
                    <div className='flex gap-2'>
                        <OutlinedInput size='small' value={'192.168.1.1'} />
                        <Button children={<RemoveIcon />} variant="contained" size="small" color='error' />
                        <Button children={<Add />} variant="contained" size="small" color='success' />
                    </div>
                </div>
                <div className='grid grid-cols-2'>
                    <Typography variant='h5' mb='5px' >Карточка</Typography>
